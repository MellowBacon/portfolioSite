...
import { getByMedium, getVisibleMediums } from '../../data/projects'
import styles from './Work.module.css'

const VISIBLE_MEDIUMS = getVisibleMediums()
const VALID_KEYS = new Set(['all', ...VISIBLE_MEDIUMS.map(m => m.key)])
        ...
        <div className="container">
          <header className={styles.header}>
            ...
            <p className={styles.count}>
              ...
              {active !== 'all' && <> &middot; {VISIBLE_MEDIUMS.find(m => m.key === active)?.label}</>}
            </p>
          </header>
